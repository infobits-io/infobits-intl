...
title: Flag
sidebar_position: 7
description: Arbejd med SVG-landeflag og emoji-flag — rendering, adgang og visning af flag i din applikation.
---

# Flag

Pakken indeholder 256 SVG-landeflag, minificeret og indlejret som strenge. Flag er indekseret efter ISO 3166-1 alpha-2-landekoder.

## SVG-flag

### Hent et flag efter landekode
...
### Rendering af SVG-flag

SVG-strengene kan bruges direkte i din applikation:
...
Emoji-flag genereres ud fra landekoder ved hjaelp af regionale indikatorsymboler.
...
Sprog kan have et repraesentativt flag via deres `defaultFlagCode`.
...
## Alle tilgaengelige flag

Iterer over alle tilgaengelige flag:
