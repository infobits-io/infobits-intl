...
export const currenciesTranslations: Record<string, Record<string, string>> = {
  "da": {
  ...
  "nl": {
    ...
    "UYI": "Uruguayaanse peso (geïndexeerde eenheden)",
    "UYU": "Uruguayaanse peso",
    "UYW": "Unidad Previsional",
    "UZS": "Oezbeekse som",
    "VED": "Venezolaanse Bolívar Digital",
    "VES": "Venezolaanse Bolívar Soberano",
    "VND": "Vietnamese dong",
    "VUV": "Vanuatuaanse vatu",
    "WST": "Samoaanse tala",
    "XAF": "CFA-frank BEAC",
    "XAG": "Zilver (één troy ounce)",
    "XAU": "Goud (één troy ounce)",
    "XBA": "Europese compositie-eenheid",
    "XBB": "Europese monetaire eenheid",
    "XBC": "Europese rekeneenheid 9",
    "XBD": "Europese rekeneenheid 17",
    "XCD": "Oost-Caribische dollar",
    "XDR": "Bijzondere Trekkingsrechten",
    "XOF": "CFA-frank BCEAO",
    "XPD": "Palladium (één troy ounce)",
    "XPF": "CFP-frank",
    "XPT": "Platina (één troy ounce)",
    "XSU": "SUCRE",
    "XTS": "Testvalutacode",
    ...
    "ZMG": "Zambiaanse kwacha (voor 2013)",
...
export function getCurrenciesName(code: string, locale: string): string | undefined {
  return currenciesTranslations[locale]?.[code];
}
